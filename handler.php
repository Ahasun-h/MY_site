...
$mail_subject = 'Message From My Website';
$mail_to_email = 'habibahasun019@gmail.com'; // your email
$mail_to_name = 'Ahasun_H';
...
try {
    ...
    $mail->Username = 'habibahasun019@gmail.com'; // SMTP username
    $mail->Password = 'habib1100@'; // SMTP password
    ...
    $mail->Body = '
		...
		<strong>Category:</strong> ' . $mail_subject . '<br>
